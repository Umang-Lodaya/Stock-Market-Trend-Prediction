...
st.markdown('Try adding various Stock Symbols. You can find Stock Symbol from [Yahoo Finance](https://finance.yahoo.com/trending-tickers)')
...
if st.button("Analyze"):
    try:
        ...
        st.title(e)
        st.markdown('You can find Stock Symbol from [Yahoo Finance](https://finance.yahoo.com/trending-tickers)')
