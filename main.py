...
st.markdown('Try adding different Stock Code. You can find Stock Code from [Yahoo Finance](https://finance.yahoo.com/trending-tickers)')
...
if st.button("ANALYZE"):
    ...
    col1.markdown('10 DAYS MA')
    col1.line_chart(df[['MA for 10 days']])

    col2.markdown('20 DAYS MA')
    col2.line_chart(df[['MA for 20 days']])

    col3.markdown('50 DAYS MA')
    col3.line_chart(df[['MA for 50 days']])
